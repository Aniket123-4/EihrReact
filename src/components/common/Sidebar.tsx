...
// import sideLogo from "../../assets/images/hospital_LOGO.png";
      ...
      <AppBarStyled position="fixed" open={open}>
        ...
        >
          ...
          <MenuItem sx={{ flexDirection: "column", alignItems: "flex-start", py: 1.5 }}>
            ...
            <Typography variant="caption" sx={{ opacity: 0.6 }}>Dr. Rahul  assigned a new patient</Typography>
          ...
          <MenuItem sx={{ flexDirection: "column", alignItems: "flex-start", py: 1.5 }}>
            ...
            <Typography variant="caption" sx={{ opacity: 0.6 }}>Results for Patient No. 0000028 available</Typography>
...
>
  {/* LEFT SIDE LOGO */}
  {open && (
    <LogoContainer sx={{ display: "flex", justifyContent: "center", width: "100%" }}>
